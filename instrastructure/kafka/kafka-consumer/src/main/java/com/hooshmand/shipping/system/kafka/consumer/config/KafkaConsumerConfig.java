package com.hooshmand.shipping.system.kafka.consumer.config;

import com.hooshmand.shipping.system.kafka.config.data.KafkaConfigData;
import com.hooshmand.shipping.system.kafka.config.data.KafkaConsumerConfigData;
